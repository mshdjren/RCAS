...
data = "MNIST"
topd_2_path = "MNIST-deep_conv_aux-MNIST_gonly_topg_5_topd_2_lr_0.0001_d_up_2-2023_09_03_23_45_16"
topd_5_path = "MNIST-deep_conv_aux-MNIST_gonly_topg_5_topd_2_lr_0.0001_d_up_2-2023_09_03_23_45_16"
topd_10_path = "MNIST-deep_conv_aux-MNIST_gonly_topg_5_topd_10_lr_0.0001_d_up_2-2023_09_03_11_00_26"
topd_100_path = "MNIST-deep_conv_aux-MNIST_gonly_topg_5_topd_100_lr_0.0001_d_up_2-2023_09_03_11_00_14"
topd_200_path = "MNIST-deep_conv_aux-MNIST_gonly_topg_5_topd_200_lr_0.0001_d_up_2-2023_09_03_10_59_57"
topd_1000_path = "MNIST-deep_conv_aux-MNIST_gonly_topg_5_topd_1000_lr_0.0001_d_up_2-2023_09_03_10_59_15"
...
for i in range(1):
    metrics = np.load("./results/final/{folder}/{data}/statistics/{topd_2_path}/train/metrics.npy".format(folder=fine_folder, data=data, topd_2_path=topd_2_path), allow_pickle=True)
    iFID_remain = np.load("./results/final/{folder}/{data}/statistics/{topd_2_path}/iFID_remain.npy".format(folder=fine_folder, data=data, topd_2_path=topd_2_path), allow_pickle=True)
    iFID_target = np.load("./results/final/{folder}/{data}/statistics/{topd_2_path}/iFID_target.npy".format(folder=fine_folder, data=data, topd_2_path=topd_2_path), allow_pickle=True)
...
for i in range(1):
    metrics = np.load("./results/final/{folder}/{data}/statistics/{topd_10_path}/train/metrics.npy".format(folder=fine_folder, data=data, topd_10_path=topd_10_path), allow_pickle=True)
    iFID_remain = np.load("./results/final/{folder}/{data}/statistics/{topd_10_path}/iFID_remain.npy".format(folder=fine_folder, data=data, topd_10_path=topd_10_path), allow_pickle=True)
    iFID_target = np.load("./results/final/{folder}/{data}/statistics/{topd_10_path}/iFID_target.npy".format(folder=fine_folder, data=data, topd_10_path=topd_10_path), allow_pickle=True)
...
for i in range(1):
    metrics = np.load("./results/final/{folder}/{data}/statistics/{topd_100_path}/train/metrics.npy".format(folder=fine_folder, data=data, topd_100_path=topd_100_path), allow_pickle=True)
    iFID_remain = np.load("./results/final/{folder}/{data}/statistics/{topd_100_path}/iFID_remain.npy".format(folder=fine_folder, data=data, topd_100_path=topd_100_path), allow_pickle=True)
    iFID_target = np.load("./results/final/{folder}/{data}/statistics/{topd_100_path}/iFID_target.npy".format(folder=fine_folder, data=data, topd_100_path=topd_100_path), allow_pickle=True)
...
for i in range(1):
    metrics = np.load("./results/final/{folder}/{data}/statistics/{topd_200_path}/train/metrics.npy".format(folder=fine_folder, data=data, topd_200_path=topd_200_path), allow_pickle=True)
    iFID_remain = np.load("./results/final/{folder}/{data}/statistics/{topd_200_path}/iFID_remain.npy".format(folder=fine_folder, data=data, topd_200_path=topd_200_path), allow_pickle=True)
    iFID_target = np.load("./results/final/{folder}/{data}/statistics/{topd_200_path}/iFID_target.npy".format(folder=fine_folder, data=data, topd_200_path=topd_200_path), allow_pickle=True)
...
for i in range(1):
    metrics = np.load("./results/final/{folder}/{data}/statistics/{topd_1000_path}/train/metrics.npy".format(folder=fine_folder, data=data, topd_1000_path=topd_1000_path), allow_pickle=True)
    iFID_remain = np.load("./results/final/{folder}/{data}/statistics/{topd_1000_path}/iFID_remain.npy".format(folder=fine_folder, data=data, topd_1000_path=topd_1000_path), allow_pickle=True)
    iFID_target = np.load("./results/final/{folder}/{data}/statistics/{topd_1000_path}/iFID_target.npy".format(folder=fine_folder, data=data, topd_1000_path=topd_1000_path), allow_pickle=True)
...
x_len = len(IS_dict["topd_10"])
# create data
for i in range(x_len):
    # x.append(save_freq * (i+1))
    x.append('{num}K'.format(num=i+1))

y_top2 = iFID_target_dict["topd_2"]
y_top10 = iFID_target_dict["topd_10"]
y_top100 = iFID_target_dict["topd_100"]
# y_top200 = iFID_target_dict["topd_200"]
y_top1000 = iFID_target_dict["topd_1000"]
...
plt.title("Top % discriminator weights re-initialization")
