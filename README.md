...
If re-initialize the top 50% weights based on importance, the `selectG_D_topk_ratio` variable is defined as 2 in the code as   $w_{ij}^{d}$  $\frac{100\%}{selectG\_D\_topk\_ratio}$
````
