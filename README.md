...
<img src=https://github.com/mshdjren/RCAS/blob/master/figures/main_figure.jpg>
 ...
 1) Estimate the importannce $\Omega_{\mu}^{\alpha}$ of each pre-trained generator and discriminator weights by calculating the gradients of each weights in inference the images of target class
